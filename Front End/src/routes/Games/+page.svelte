...
<label
  >Click here to search for a game <a href="/Games/Search"
...
{#if !isLoading}
  <main>
    <label
      >Click on this tab to select your category to see all the best games from
      this category:
      <select
      ...
      >
      <p>
        Currently searching for best Games sorted by {RatingChange[
          ratingSelect
        ]} score
      </p>
      <ol id="grid-container">
        {#each $gamesSortedData as game}
          <div class="fullGamesCard" id="grid-item">
